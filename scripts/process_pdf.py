...
pdf_file_path = os.path.join("data", "raw", "Obsessions_Repetitive_Behaviour_Refined.pdf ")

# Extract and clean text
cleaned_text = extract_text_from_pdf(pdf_file_path)

# Save cleaned text as a processed file
output_path = os.path.join("data", "processed", "obsessions_repetitive_behaviour_refined.txt")
