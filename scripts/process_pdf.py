...
pdf_file_path = os.path.join("data", "raw", "Helpful_Strategies_Positive_Behavior_Refined.pdf ")

# Extract and clean text
cleaned_text = extract_text_from_pdf(pdf_file_path)

# Save cleaned text as a processed file
output_path = os.path.join("data", "processed", "helpful_strategies_positive_behavior_refined.txt")
